...
<link href="p5.css" rel="stylesheet">
...
<div class="container">
<h1 id="navbar"><strong>Currency Conversion</strong>
</h1>
</div>
</div>
...
<input id="inAmt" type="text" name="currency_input" />
</div>
<div class="jumbotron text-center">
<label>Select currency (from):</label>
<select class="selctrs" name="currency_from">
...
<select class="selctrs" name="currency_to">
<option  value="EUR">Euro (€)</option>
...
<br/>
<input id="convBttn" type="submit" value="Convert!" />
</div>
...
if($display_result) {
    if(is_numeric($currency_input)){
        echo"<div class='container'><div class='jumbotron text-center'><strong>$currency_input $currency_from = $currency $currency_to</strong></div></div>";
    }else
        echo"<div class='container'><div class='jumbotron text-center'><strong>Please enter a number.</strong></div></div>";
}
